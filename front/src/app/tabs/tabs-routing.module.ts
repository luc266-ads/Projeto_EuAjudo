...
const routes: Routes = [
  {
    ...
    children: [
      {
        path: 'tab1',
        loadChildren: () => import('../cadastro/tab1.module').then(m => m.Tab1PageModule)
      },
      {
        path: 'tab2',
        loadChildren: () => import('../quemSomos/tab2.module').then(m => m.Tab2PageModule)
      },
      ...
      {
        path: 'tab4',
        loadChildren: () => import('../questionario/tab4.module').then(m => m.Tab4PageModule)
      },
      {
        path: 'tab5',
